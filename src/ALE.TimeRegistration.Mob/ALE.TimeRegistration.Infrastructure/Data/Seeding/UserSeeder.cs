    ...
    public class UserSeeder
    {
        ...
        public static void Seed(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<User>().HasData(
                new User { DateOfBirth = DateTime.Parse("01/05/1985 0:00:00"), LastName = "Romers", Name = "Andre", Email = "andreRomersDenBesten@hotmail.com", Password = "TimeReg2020" },
                ...
                new User { DateOfBirth = DateTime.Parse("03/04/1990 0:00:00"), LastName = "Deroe", Name = "Karel", Email = "CharlesDerue@hotmail.com", Password = "TimeReg2020" },
                ...
                new User { DateOfBirth = DateTime.Parse("02/11/1984 0:00:00"), LastName = "Limskova", Name = "Natasha", Email = "NatLimsko@hotmail.com", Password = "TimeReg2020" },
                ...
                new User { DateOfBirth = DateTime.Parse("01/03/1972 0:00:00"), LastName = "Demain", Name = "Annie", Email = "TomorrowAnnie@hotmail.com", Password = "TimeReg2020" },
                new User { DateOfBirth = DateTime.Parse("13/02/1985 0:00:00"), LastName = "Muylebroeck", Name = "Sara", Email = "SaraMuyle@hotmail.com", Password = "TimeReg2020" },
                ...
                new User { DateOfBirth = DateTime.Parse("04/05/1989 0:00:00"), LastName = "Duck", Name = "Edward", Email = "EdwardLeCanard@hotmail.com", Password = "TimeReg2020" },
                ...
                new User { DateOfBirth = DateTime.Parse("15/09/1991 0:00:00"), LastName = "Geevaert", Name = "Jasper", Email = "JasperGeevaert@hotmail.com", Password = "TimeReg2020" },
                new User { DateOfBirth = DateTime.Parse("26/08/1999 0:00:00"), LastName = "Uytebroeck", Name = "Piet", Email = "ZwaffelPiet@gmail.com", Password = "TimeReg2020" },
                ...
                new User { DateOfBirth = DateTime.Parse("18/02/1993 0:00:00"), LastName = "De Cruce", Name = "Moyra", Email = "mdecruce2@jigsy.com", Password = "TimeReg2020" },
                ...
                new User { DateOfBirth = DateTime.Parse("02/09/1992 0:00:00"), LastName = "Thuys", Name = "Benny", Email = "mdecruce2@jigsy.com", Password = "TimeReg2020" },
                new User { DateOfBirth = DateTime.Parse("23/10/1978 0:00:00"), LastName = "Tout", Name = "Willy", Email = "WilAlles@hotmail.com", Password = "TimeReg2020" },
