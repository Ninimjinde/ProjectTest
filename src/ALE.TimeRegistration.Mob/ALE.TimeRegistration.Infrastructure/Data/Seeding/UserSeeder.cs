    ...
    public class UserSeeder
    {
        ...
        public static void Seed(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<User>().HasData(
                new User { DateOfBirth = DateTime.Parse("28/08/1984 0:00:00"), LastName = "Cash", Name = "Johnny", Email = "aboynamedsue@JCash.com", Password = "TimeReg2020", Id = Guid.Parse("12ba3def-f041-45dd-bb6c-492749f49d89") },
                ...
                new User { DateOfBirth = DateTime.Parse("14/12/1983 0:00:00"), LastName = "Declerk", Name = "Yoeri", Email = "DeYoeri@gmail.com", Password = "TimeReg2020", Id = Guid.Parse("1e62ec6c-0f76-4a30-b5c5-15690658930f") },
                new User { DateOfBirth = DateTime.Parse("27/10/1978 0:00:00"), LastName = "Thee", Name = "Camille", Email = "CalmingCamille@telenet.be", Password = "TimeReg2020", Id = Guid.Parse("66d7e6a2-404e-4919-b032-abf64cfe691f") },
                new User { DateOfBirth = DateTime.Parse("15/09/1991 0:00:00"), LastName = "Homme", Name = "Josh", Email = "Thebestginger@qotsa.com", Password = "TimeReg2020", Id = Guid.Parse("00748570-86f3-42c3-a358-8ea38c706cb8") },
                ...
                new User { DateOfBirth = DateTime.Parse("17/07/1978 0:00:00"), LastName = "Lefort", Name = "Jan", Email = "SterkeJan33@pandora.be", Password = "TimeReg2020", Id = Guid.Parse("a9ac8612-f8b7-4344-9042-875b1b916e1a") },
                ...
                new User { DateOfBirth = DateTime.Parse("18/02/1993 0:00:00"), LastName = "Lambregt", Name = "Willy", Email = "willywilly@thescabs.be", Password = "TimeReg2020", Id = Guid.Parse("67859443-f004-4779-bfb0-3ad2cfa6a154") },
                ...
                new User { DateOfBirth = DateTime.Parse("20/06/1984 0:00:00"), LastName = "Emnie", Name = "Ben", Email = "Giezijtem@skynet.be", Password = "TimeReg2020", Id = Guid.Parse("6cac4bc5-293e-4b8a-836c-04f46a681b2f") },
                ...
                new User { DateOfBirth = DateTime.Parse("21/08/1999 0:00:00"), LastName = "Celie", Name = "Peter", Email = "GezondePeter@telenet.be", Password = "TimeReg2020", Id = Guid.Parse("88328685-37dc-45d7-aef0-a7095dbbf9e1") },
